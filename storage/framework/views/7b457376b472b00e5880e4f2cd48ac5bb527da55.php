...
<!-- Tell the browser to be responsive to screen width -->
  ...
  <!-- timepicker -->
  <link rel="stylesheet" href="<?php echo e(asset('public/jquery-timepicker/jquery.timepicker.min.css')); ?>">
  ...
  <script src="<?php echo e(asset('public/jquery-chained/jquery.chained.js')); ?>"></script>
...
<body id="page-top"><?php /**PATH C:\xampp\htdocs\TA_PPL\resources\views/admin/layout/head.blade.php ENDPATH**/ ?>