...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
      ...
      <a href="<?php echo e(asset('admin/dasbor')); ?>" class="btn btn-sm"><i class="fa fa-tachometer-alt"></i> Dasbor</a> 
      <a href="<?php echo e(asset('/')); ?>" class="btn btn-sm" target="_blank"><i class="fa fa-home"></i> Beranda</a>
      <!-- Topbar Navbar -->
        ...
        <li class="nav-item dropdown no-arrow mx-1">
          ...
          <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
            ...
            <?php foreach($nav_pemesanan as $nav_pemesanan) { ?>     
              <a class="dropdown-item d-flex align-items-center" href="<?php echo e(asset('admin/pemesanan/detail/'.$nav_pemesanan->id_pemesanan)); ?>">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="<?php echo e(asset('public/upload/image/thumbs/'.$nav_pemesanan->gambar)); ?>" alt="">
            ...
            <?php } ?>
            <a class="dropdown-item text-center small text-gray-500" href="<?php echo e(asset('admin/pemesanan')); ?>"><i class="fa fa-shopping-cart"></i> Lihat semua Order...</a>
          </div>
        </li>
    ...
    <div class="container-fluid">
      ...
      <!-- Page Heading -->
      <h1 class="h3 mb-2 text-gray-800"><?php echo e($title); ?></h1>
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <div class="table-responsive" style="min-height: 500px;"><?php /**PATH C:\xampp\htdocs\TA_PPL\resources\views/admin/layout/menu.blade.php ENDPATH**/ ?>