...
<!-- ======= Header ======= -->
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
            ...
            <li><a href="<?php echo e(asset('berita/read/'.$nav_profil->slug_berita)); ?>">Profil</a></li>
            <li><a href="<?php echo e(asset('produk')); ?>">Pengumuman</a></li>
            <!-- <li><a href="<?php echo e(asset('galeri')); ?>">Data Santri</a></li> -->
            <li><a href="<?php echo e(asset('video')); ?>">Data Santri</a></li>
  ...
  </header><!-- End Header --><!-- ======= Hero Section ======= --><?php /**PATH C:\xampp\htdocs\TA_PPL\resources\views/layout/header.blade.php ENDPATH**/ ?>