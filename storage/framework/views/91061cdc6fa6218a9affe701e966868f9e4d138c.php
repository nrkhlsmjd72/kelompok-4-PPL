<p class="text-right">
  <a href="<?php echo e(asset('admin/galeri')); ?>" 
...
<form action="<?php echo e(asset('admin/galeri/tambah_proses')); ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
...
<div class="col-md-9">
<input type="text" name="judul_galeri" class="form-control" placeholder="Judul galeri" value="<?php echo e(old('judul_galeri')); ?>">
</div>
</div>
...
<div class="col-md-3">
<input type="number" name="urutan" class="form-control" placeholder="No urut tampil" value="<?php echo e(old('urutan')); ?>">
...
<div class="col-md-9">
<textarea name="isi" id="isi" class="form-control konten" placeholder="Isi galeri"><?php echo e(old('isi')); ?></textarea>
</div>
</div>
...
<div class="col-md-9">
<input type="url" name="website" class="form-control" placeholder="http://website.com" value="<?php echo e(old('website')); ?>">
</div>
</div>
...
</form><?php /**PATH C:\xampp\htdocs\TA_PPL\resources\views/admin/galeri/tambah.blade.php ENDPATH**/ ?>