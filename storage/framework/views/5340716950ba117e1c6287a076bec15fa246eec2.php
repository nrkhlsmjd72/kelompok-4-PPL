...
tinymce.init({
  selector: '.konten',
  height: 300,
  content_css: '<?php echo e(asset("public/template/assets/vendor/bootstrap/css/bootstrap.min.css")); ?>',
...
//     "filemanager": "<?php echo e(asset('public/filemanager/plugin.min.js')); ?>"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?php echo e(asset('login/logout')); ?>"><i class="fa fa-sign-out-alt"></i> Logout</a>
        </div>
      </div>
    </div>
  </div>
...
</html><?php /**PATH C:\xampp\htdocs\TA_PPL\resources\views/admin/layout/footer.blade.php ENDPATH**/ ?>