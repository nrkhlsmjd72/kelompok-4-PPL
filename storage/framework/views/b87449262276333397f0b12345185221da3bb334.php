...
<div class="row">
  ...
  <div class="col-md-6">
    <form action="<?php echo e(asset('admin/galeri/cari')); ?>" method="get" accept-charset="utf-8">
    <br>
    <div class="input-group">                  
      ...
      <span class="input-group-btn btn-flat">
        ...
        <a href="<?php echo e(asset('admin/galeri/tambah')); ?>" class="btn btn-success">
...
<form action="<?php echo e(asset('admin/galeri/proses')); ?>" method="post" accept-charset="utf-8">
        ...
        <tbody>
          ...
          <?php $i=1; foreach($galeri as $galeri) { ?>
            ...
            <tr class="odd gradeX">
              ...
              <td><img src="<?php echo e(asset('public/upload/image/thumbs/'.$galeri->gambar)); ?>" class="img img-thumbnail img-fluid"></td>
              <td><?php echo $galeri->judul_galeri ?></td>
              <td><a href="<?php echo e(asset('admin/galeri/kategori/'.$galeri->id_kategori_galeri)); ?>"><?php echo $galeri->nama_kategori_galeri ?></a></td>
              <td><a href="<?php echo e(asset('admin/galeri/status_galeri/'.$galeri->jenis_galeri)); ?>">
                  <?php echo $galeri->jenis_galeri ?></a></td>
              <td>
                    <div class="btn-group">

                        <a href="<?php echo e(asset('admin/galeri/edit/'.$galeri->id_galeri)); ?>" 
                          class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

                          <a href="<?php echo e(asset('admin/galeri/delete/'.$galeri->id_galeri)); ?>" class="btn btn-danger btn-sm delete-link"><i class="fa fa-trash"></i></a>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\TA_PPL\resources\views/admin/galeri/index.blade.php ENDPATH**/ ?>