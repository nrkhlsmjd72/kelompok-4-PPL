            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <div class="text-center">
                    <a class="small" href="<?php echo e(asset('login/lupa')); ?>">Lupa Password?</a> | <a class="small" href="<?php echo e(asset('/')); ?>">Kembali ke Beranda</a>
                  </div>
                </div>
              </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\TA_PPL\resources\views/login/index.blade.php ENDPATH**/ ?>