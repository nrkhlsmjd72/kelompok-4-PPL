	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo e(asset('admin/video/tambah')); ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
<?php echo e(csrf_field()); ?>

				<div class="form-group row">
					<label class="col-sm-3 control-label text-right">Judul Video</label>
					<div class="col-sm-9">
						<input type="text" name="judul" class="form-control" placeholder="Judul Video" value="<?php echo e(old('judul')); ?>" required>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" name="video" class="form-control" placeholder="Kode Video Youtube" value="<?php echo e(old('video')); ?>" required>
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="number" name="urutan" class="form-control" placeholder="Urutan" value="<?php echo e(old('urutan')); ?>" required>
					</div>
				</div>
...
<?php /**PATH C:\xampp\htdocs\TA_PPL\resources\views/admin/video/tambah.blade.php ENDPATH**/ ?>