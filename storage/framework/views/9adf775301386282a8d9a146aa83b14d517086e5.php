...
<form action="<?php echo e(asset('admin/kategori_produk/edit')); ?>" enctype="multipart/form-data"  method="post" accept-charset="utf-8">
<?php echo e(csrf_field()); ?>

<input type="hidden" name="id_kategori_produk"   value="<?php echo e($kategori_produk->id_kategori_produk); ?>">
...
<div class="form-group row">
	...
	<div class="col-md-9">
		<textarea name="keterangan" class="form-control simple" placeholder="Keterangan"><?php echo e($kategori_produk->keterangan); ?></textarea>
...
<?php /**PATH C:\xampp\htdocs\TA_PPL\resources\views/admin/kategori_produk/edit.blade.php ENDPATH**/ ?>