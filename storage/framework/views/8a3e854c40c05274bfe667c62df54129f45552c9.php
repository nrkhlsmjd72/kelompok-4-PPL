<form action="<?php echo e(asset('admin/berita/proses')); ?>" method="post" accept-charset="utf-8">
...
<button class="btn btn-danger" type="submit" name="hapus" onClick="check();" >
  ...
  <button class="btn btn-warning" type="submit" name="draft" onClick="check();" >
   ...
   <button class="btn btn-primary" type="submit" name="publish" onClick="check();" >
    ...
    <a href="<?php echo e(asset('admin/berita/tambah')); ?>" class="btn btn-success ">
...
<tr class="odd gradeX">
    ...
    <?php if($berita->gambar!="") { ?>
      <img src="<?php echo e(asset('public/upload/image/thumbs/'.$berita->gambar)); ?>" class="img img-thumbnail img-responsive" >
      <?php }else{ ?>
      <img src="<?php echo e(asset('public/upload/image/thumbs/'.$site->icon)); ?>" class="img img-thumbnail img-responsive" >
      <?php } ?>
    </td>
    <td>
    <a href="<?php echo e(asset('admin/berita/edit/'.$berita->id_berita)); ?>">
    ...
    <td>
    <a href="<?php echo e(asset('admin/berita/kategori/'.$berita->id_kategori)); ?>">
    <?php echo $berita->nama_kategori ?><sup><i class="fa fa-link"></i></sup>
    </a>
    </td>
    <td>
    <a href="<?php echo e(asset('admin/berita/jenis_berita/'.$berita->jenis_berita)); ?>">
    <?php echo $berita->jenis_berita ?><sup><i class="fa fa-link"></i></sup>
    </a></td>
    <td><a href="<?php echo e(asset('admin/berita/status_berita/'.$berita->status_berita)); ?>">
    ...
    <td>
    <a href="<?php echo e(asset('admin/berita/author/'.$berita->id_user)); ?>">
    <?php echo $berita->nama ?><sup><i class="fa fa-link"></i></sup>
    </a></td>
    <td>
      <div class="btn-group">
        <a href="<?php echo e(asset('berita/read/'.$berita->slug_berita)); ?>" 
        class="btn btn-success btn-sm" target="_blank"><i class="fa fa-eye"></i></a>

        <a href="<?php echo e(asset('admin/berita/edit/'.$berita->id_berita)); ?>" 
        class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

        <a href="<?php echo e(asset('admin/berita/delete/'.$berita->id_berita)); ?>" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i></a>
      </div>
    </td>
</tr>
...
</form><?php /**PATH C:\xampp\htdocs\TA_PPL\resources\views/admin/berita/index.blade.php ENDPATH**/ ?>